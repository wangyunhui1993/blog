! function(e) {
	...
	! function(i, a) {
		...
		var R, I = String.prototype.valueOf,
			L = function(e) {
				try {
					return I.call(e), !0
				} catch(e) {
		...
		var B = g.bind(i.hasOwnProperty),
			...
			J = g.bind(l.indexOf),
			$ = g.bind(h),
			Z = g.bind(i.propertyIsEnumerable),
			X = g.bind(r.sort),
		...
		F(r, {
			...
			map: function(t) {
				var r, o = W.ToObject(this),
					i = ne && R(this) ? z(this, "") : o,
		...
		F(r, {
			indexOf: function(e) {
				var t = ne && R(this) ? z(this, "") : W.ToObject(this),
					n = W.ToUint32(t.length);
				if(0 === n) return -1;
				var r = 0;
				for(arguments.length > 1 && (r = W.ToInteger(arguments[1])), r = r >= 0 ? r : b(0, n + r); r < n; r++)
		...
		F(r, {
			splice: function(e, t) {
				...
				if(p < l) {
					...
					for(c = i - l; c > u;) n = s(c + l - 1), d = s(c + p - 1), B(r, n) ? r[d] = r[n] : delete r[d], c -= 1;
				c = u;
		...
		F(o, {
			keys: function(t) {
				...
				var a = [],
					u = Me && n;
				if(i && Ee || r)
					for(var l = 0; l < t.length; ++l) $(a, s(l));
				if(!r)
					for(var c in t) u && "prototype" === c || !B(t, c) || $(a, s(c));
				if(we)
					for(var d = xe(t), f = 0; f < De; f++) {
						var p = Oe[f];
		...
		var Ae, je, Fe = 0 !== new Date(-0xc782b5b342b24).getUTCMonth(),
			Ue = new Date(-0x55d318d56a724),
			Ye = new Date(14496624e5),
			We = "Mon, 01 Jan -45875 11:59:59 GMT" !== Ue.toUTCString(),
		...
		var Be = g.bind(Date.prototype.getFullYear),
			He = g.bind(Date.prototype.getMonth),
			qe = g.bind(Date.prototype.getDate),
			Ge = g.bind(Date.prototype.getUTCFullYear),
			Ke = g.bind(Date.prototype.getUTCMonth),
			ze = g.bind(Date.prototype.getUTCDate),
			Je = g.bind(Date.prototype.getUTCDay),
			$e = g.bind(Date.prototype.getUTCHours),
			Ze = g.bind(Date.prototype.getUTCMinutes),
			Xe = g.bind(Date.prototype.getUTCSeconds),
			Qe = g.bind(Date.prototype.getUTCMilliseconds),
		...
		if(dt || ct || !lt) {
			var ft = Math.pow(2, 31) - 1,
				pt = Y(new Date(1970, 0, 1, 0, 0, 0, ft + 1).getTime());
			Date = function(e) {
		...
		var ht = d.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)),
			...
			vt = function(e) {
				...
				if(r = "", n < 0 && (r = "-", n = -n), o = "0", n > 1e-21)
					if(i = mt.log(n * mt.pow(2, 69, 1)) - 69, a = i < 0 ? n * mt.pow(2, -i, 1) : n / mt.pow(2, i, 1), a *= 4503599627370496, i = 52 - i, i > 0) {
	...
	! function(i, a) {
		...
		if(Object.defineProperty) {
			var M = w({}),
				E = "undefined" == typeof document || w(document.createElement("div"));
			if(!M || !E) var C = Object.defineProperty,
	...
	var o = n(8),
		...
		v = "bubble",
		y = "chameleon",
		g = "73cd93ca-5573-11e6-beb8-9e71128cae77",
		_ = {},
		b = {},
		w = {
			init: function(e, t) {
			...
			show: function(e) {
				...
				if(t) {
					...
					if(!document.getElementById(r)) {
						...
						}, s.default.createElement(o.Provider, {
							store: n
		...
		E = window.ThinkPageWeatherWidgetObject || "weatherWidget",
		C = window[E];
		...
		c = {
			...
			processUpdates: function(e, t) {
				for(var n, a = null, c = null, d = 0; d < e.length; d++)
					if(n = e[d], n.type === i.MOVE_EXISTING || n.type === i.REMOVE_NODE) {
						var f = n.fromIndex,
							p = n.parentNode.childNodes[f],
							h = n.parentID;
	...
	function _(e) {
		for(; e && e.parentNode !== e; e = e.parentNode)
			if(1 === e.nodeType) {
				var t = u(e);
				if(t) {
					var n, r = T.getReactRootIDFromNodeID(t),
						o = e;
					do
	...
	var b = n(31),
		...
		j = n(27),
		F = n(75),
		U = (n(78), n(33), b.ID_ATTRIBUTE_NAME),
		Y = {},
		W = 1,
		V = 9,
		B = 11,
	...
	var $ = {
		...
		_renderSubtreeIntoContainer: function(e, t, n, r) {
			...
			var a = new E(J, null, null, null, null, null, t),
				s = q[i(n)];
			if(s) {
	...
	function u(e) {
		...
		for(var n = 0; n < t; n++) {
			...
			if(r._pendingCallbacks = null, p.performUpdateIfNecessary(r, e.reconcileTransaction), o)
	...
	var C = m.canUseDOM && "TextEvent" in window && !E && !r(),
		T = m.canUseDOM && (!M || E && E > 8 && E <= 11),
		S = 32,
	...
	var y = n(102),
		...
		F = n(27),
		U = n(28),
		Y = (n(125), n(78), n(33), M.deleteListener),
		W = M.listenTo,
		V = M.registrationNameModules,
		B = {
			string: !0,
			number: !0
		},
		...
		_createInitialChildren: function(e, t, n, r) {
			...
			if(null != o) null != o.__html && F(r, o.__html);
				...
				if(null != i) U(r, i);
					...
					for(var u = this.mountChildren(a, e, n), s = 0; s < u.length; s++) r.appendChild(u[s])
			}
		},
		receiveComponent: function(e, t, n) {
			var r = this._currentElement;
		...
		_updateDOMProperties: function(e, t, n, r) {
			...
			for(o in t) {
				...
				if(t.hasOwnProperty(o) && s !== c)
					if(o === q)
						if(s ? s = this._previousStyleCopy = R({}, s) : this._previousStyleCopy = null, c) {
							for(i in c) !c.hasOwnProperty(i) || s && s.hasOwnProperty(i) || (a = a || {}, a[i] = "");
							for(i in s) s.hasOwnProperty(i) && c[i] !== s[i] && (a = a || {}, a[i] = s[i])
						} else a = s;
				else V.hasOwnProperty(o) ? s ? l(this._rootNodeID, o, s, n) : c && Y(this._rootNodeID, o) : m(this._tag, t) ? (r || (r = D.getNode(this._rootNodeID)), o === H && (s = null), b.setValueForAttribute(r, o, s)) : (_.properties[o] || _.isCustomAttribute(o)) && (r || (r = D.getNode(this._rootNodeID)), null != s ? b.setValueForProperty(r, o, s) : b.deleteValueForProperty(r, o))
			}
	...
	i.measureMethods(p, "CSSPropertyOperations", {
	...
	function u(e, t, n, r) {
		...
		var s, c, m = 0,
			v = "" === t ? p : t + h;
		if(Array.isArray(e))
			for(var y = 0; y < e.length; y++) s = e[y], c = v + o(s, y), m += u(s, c, n, r);
		else {
			var g = d(e);
			if(g) {
				var _, b = g.call(e);
				if(g !== e.entries)
					for(var w = 0; !(_ = b.next()).done;) s = _.value, c = v + o(s, w++), m += u(s, c, n, r);
				else
					for(; !(_ = b.next()).done;) {
						var M = _.value;
	...
	var a = n(114),
		...
		s = n(62),
		l = n(47),
		c = (n(33), "__ReactDOMSelect_value$" + Math.random().toString(36).slice(2)),
		d = {
			valueContextKey: c,
			getNativeProps: function(e, t, n) {
				return l({}, t, {
				...
				for(u in t)
					if(t.hasOwnProperty(u)) {
						var s = e && e[u],
							...
							c = t[u];
						if(null != s && a(l, c)) o.receiveComponent(s, c, n, r), t[u] = s;
						else {
			...
			var n = "Connect(" + u(e) + ")",
				r = function(r) {
					...
					return a(u, r), u.prototype.shouldComponentUpdate = function() {
						...
						var f = !0;
						return f = !!(s || l || t) && this.updateMergedPropsIfNeeded(), !f && i ? i : (M ? this.renderedElement = (0, d.createElement)(e, c({}, this.mergedProps, {
							ref: "wrappedInstance"
		...
		S = function(e) {
			...
			return(0, f.default)(t, e), t.prototype.componentDidMount = function() {
				...
				var e = this.props,
					...
					a = e.FullOpened,
					u = e.page;
				return "slim" === n.flavor ? h.default.createElement("div", {
					className: "tpwthwidt"
	...
	e.exports = function(e, t, n, g, _, b, w) {
		...
		var M, E, C, T = function(e) {
			...
			P = D[f] || D[h] || _ && D[_],
			k = P || T(_),
			N = _ ? x ? T("entries") : k : void 0,
			R = "Array" == t ? D.entries || P : P;
		if(R && (C = d(R.call(new e)), C !== Object.prototype && (c(C, S, !0), r || u(C, f) || a(C, f, y))), x && P && P.name !== v && (O = !0, k = function() {
				return P.call(this)
			}), r && !w || !p && !O && D[f] || a(D, f, k), s[t] = k, s[S] = y, _)
			if(M = {
					values: x ? k : T(v),
					keys: b ? k : T(m),
					entries: N
				}, w)
				for(E in M) E in D || i(D, E, M[E]);
	...
	var r = n(204),
		...
		z = function(e, t, n) {
			return e === W && z(Y, t, n), _(e), t = w(t, !0), _(n), o(U, t) ? (n.enumerable ? (o(e, L) && e[L][t] && (e[L][t] = !1), n = E(n, {
				enumerable: M(0, !1)
			})) : (o(e, L) || D(e, L, M(1, {})), e[L][t] = !0), q(e, t, n)) : D(e, t, n)
		},
		J = function(e, t) {
			_(e);
	...
	var r = n(225),
		o = n(235).concat("length", "prototype");
	...
	var r, o, i, a = n(202),
		...
		C = !! function() {
			try {
				var e = w.resolve(1),
					t = (e.constructor = {})[n(238)("species")] = function(e) {
						e(E, E)
					};
		...
		R = function(e) {
			v.call(u, function() {
				var t;
				M ? b.emit("rejectionHandled", e) : (t = u.onrejectionhandled) && t({
					promise: e,
					reason: e._v
				})
			})
	...
	C || (w = function(e) {
		...
		Promise: w
	}), n(237)(w, g), n(299)(g), i = n(205)[g], c(c.S + c.F * !C, g, {
		reject: function(e) {
			var t = x(this),
				n = t.reject;
		...
		t = e.exports = function(e, t, n, d, f) {
			...
			if(i(y)) {
				for(p = u(e.length); p > _; _++)
					if(v = t ? g(a(h = e[_])[0], h[1]) : g(e[_]), v === l || v === c) return v
			} else
				for(m = y.call(e); !(h = m.next()).done;)
					if(v = o(m, g, h.value, t), v === l || v === c) return v
		};
	...
	e.exports = function(e, t, r, o) {
		...
		u > 0 && s > u && (s = u);
		for(var l = 0; l < s; ++l) {
			var c, d, f, p, h = e[l].replace(a, "%20"),
				m = h.indexOf(r);
		...
		b = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.componentDidMount = function() {
				...
				var e = this.props,
					t = e.actions,
					n = e.load,
					r = this.getTheme("ruler");
				"dataConfig" == n && (this.preloadedPrepare(), t.ruler({
					textLen: document.getElementsByClassName(r.title)[0].offsetWidth
				}))
				...
				var e = this.props.weather,
					t = this.getTheme("ruler");
	...
	var o = n(192),
		...
		g = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getWigetClassName = function(e, t, n, r) {
				var o = e.fallback,
					i = e.widget,
					a = t.length ? e.widgetAlarmed : e.widgetNotAlarmed,
					u = e["widgetBg" + n.code],
					s = o + " " + i + " " + a + " " + u;
				if(r) {
				...
				var e = this.getPaddingStyle(),
					t = this.props.textLen;
	...
	var o = n(192),
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getWeatherIcon = function(e) {
				var t = this.getTheme("icon"),
					n = this.getTheme("container");
	...
	var o = n(192),
		...
		R = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getClassName = function(e, t) {
				...
				return d.default.createElement("div", {
					className: this.getClassName(c, u)
	...
	var o = n(192),
		...
		y = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getLastUpdate = function(e) {
				var t = {
					date: (0, p.default)(e).format("HH:mm")
				};
				...
				}, this.getLastUpdate(n.last_update)))), d.default.createElement("div", {
					className: r.wapContainer
				}, d.default.createElement("div", {
					className: r.name
				}, d.default.createElement("div", {
					className: r.title
	...
	(function(e) {
		! function(t, n) {
			...
			function g(e, t) {
				var n, r, o;
				if(u(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), u(t._i) || (e._i = t._i), u(t._f) || (e._f = t._f), u(t._l) || (e._l = t._l), u(t._strict) || (e._strict = t._strict), u(t._tzm) || (e._tzm = t._tzm), u(t._isUTC) || (e._isUTC = t._isUTC), u(t._offset) || (e._offset = t._offset), u(t._pf) || (e._pf = m(t)), u(t._locale) || (e._locale = t._locale), Cr.length > 0)
					for(n = 0; n < Cr.length; n++) r = Cr[n], o = t[r], u(o) || (e[r] = o);
				return e
			}
			...
			function at(e) {
				var t, n, r, o, i, a, u = e._i,
					s = jo.exec(u) || Fo.exec(u);
				if(s) {
					for(m(e).iso = !0, t = 0, n = Yo.length; t < n; t++)
						if(Yo[t][1].exec(s[1])) {
							o = Yo[t][0], r = Yo[t][2] !== !1;
							break
						}
			...
			function ut(e) {
				...
				if(t = e._i.replace(/\([^\)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s|\s$/g, ""), n = Bo.exec(t)) {
					if(r = n[1] ? "ddd" + (5 === n[1].length ? ", " : " ") : "", o = "D MMM " + (n[2].length > 10 ? "YYYY " : "YY "), i = "HH:mm" + (n[4] ? ":ss" : ""), n[1]) {
						var d = new Date(n[2]),
							f = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][d.getDay()];
			...
			function ft(e) {
				var t, n, r, o, i, a, u, s;
				if(t = e._w, null != t.GG || null != t.W || null != t.E) i = 1, a = 4, n = lt(t.GG, e._a[uo], Ce(wt(), 1, 4).year), r = lt(t.W, 1), o = lt(t.E, 1), (o < 1 || o > 7) && (s = !0);
				else {
			...
			function gt(e) {
				...
				return e._locale = e._locale || rt(e._l), null === t || void 0 === n && "" === t ? y({
					nullInput: !0
				}) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), b(t) ? new _(it(t)) : (l(t) ? e._d = t : o(n) ? mt(e) : n ? pt(e) : _t(e), v(e) || (e._d = null), e))
			}
			...
			function Tt(e) {
				for(var t in e)
					if(Ko.indexOf(t) === -1 || null != e[t] && isNaN(e[t])) return !1;
			...
			return(0, l.default)(t, e), t.prototype.combineAlarms = function(e, t) {
				...
				if("circle" != o) return d.default.createElement("div", null, t.map(function(e, t) {
					return d.default.createElement(v.default, {
						...
						alarm: e,
						type: "",
						tooltip: n ? e.description : ""
					})
				}));
				if(t.length <= 0 && "enable" == i) {
					var u = {};
					return u.type = "", u.typeCode = "placeholder", u.levelCode = "placeholder", d.default.createElement(g.default, {
						alarm: u
					})
				}
				if(1 == t.length) {
					var s = {};
					return s.type = "", s.typeCode = t[0].typeCode, s.levelCode = t[0].levelCode, d.default.createElement(g.default, {
						alarm: s
					})
				}
				if(t.length > 1) {
	...
	var o = n(192),
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getBackground = function(e) {
				var t = this.getTheme("alarm"),
					n = t.alarmCoverBadge;
				"placeholder" == e.levelCode && (n = t.alarmGlanceBadge);
				var r = t["background-" + e.levelCode],
					o = t["text-" + e.levelCode];
				return n + " " + r + " " + o
			}, t.prototype.getAlarmIcon = function(e) {
				var t = this.getTheme("alarm"),
					n = t["icon-" + e.typeCode],
					r = t["color-" + e.levelCode];
				return t.icon + " " + n + " " + r
			}, t.prototype.getAlarmIcon2 = function(e) {
				var t = this.getTheme("alarm"),
					n = t["icon-" + e.typeCode],
					r = t["iconColor-" + e.levelCode];
				return t.icon + " " + n + " " + r
			}, t.prototype.render = function() {
				var e = this.props,
					t = e.alarm,
					n = e.type,
					r = e.tooltip,
					o = this.getTheme("alarm"),
					i = null;
				return i = r ? d.default.createElement("div", {
					className: o.tooltip
				}, d.default.createElement("span", {
					className: o.alarmBadge
				}, d.default.createElement("i", {
					className: this.getAlarmIcon(t)
				}), " " + t.type), d.default.createElement("span", {
					className: o.tooltiptext
				}, r)) : "chameleon" == n ? d.default.createElement("div", null, d.default.createElement("span", {
					className: this.getBackground(t)
				}, d.default.createElement("i", {
					className: this.getAlarmIcon2(t)
				}), " " + t.type)) : d.default.createElement("div", {
					className: o.tooltip
				}, d.default.createElement("span", {
					className: o.alarmBadge
				}, d.default.createElement("i", {
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getBackground = function(e) {
				...
				var e = this.props.alarm,
					t = d.default.createElement("div", null, d.default.createElement("span", {
						className: this.getBackground(e)
					}, d.default.createElement("i", {
						className: this.getAlarmIcon(e)
					})));
				return t
			}, t
		}((0, h.default)(f.ThemeableMixin));
		...
		y = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.render = function() {
				var e = this.props,
					...
					n = e.air,
					r = e.type,
					o = this.getTheme("padding"),
					i = {
						wind_direction: t.wind_direction,
						wind_scale: t.wind_scale
					},
					a = this.getLocale("wind", i),
					u = this.getLocale("wind_value", i),
					s = void 0,
					l = void 0;
				if(n) {
					var c = {
						quality: n.city.quality,
						aqi: n.city.aqi
					};
					s = this.getLocale("aqi", c), l = this.getLocale("aqi_value", c)
				} else s = this.getLocale("aqi_missed"), l = this.getLocale("aqi_value_missed");
				var f = this.getLocale("humidity"),
					p = this.getLocale("humidity_value", {
						humidity: t.humidity
					});
				return d.default.createElement("div", {
					className: o.extra
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.render = function() {
				var e = this.props,
					...
					n = e.value,
					r = e.type,
					o = this.getTheme("extraItem");
				return "slim" == r ? d.default.createElement("div", {
					className: o.title
				}, t + " " + n) : d.default.createElement("div", {
					className: o.item
				}, d.default.createElement("div", {
					className: o.title
	...
	var o = n(192),
		...
		y = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getSubtitleClassName = function(e, t) {
				...
				var t = this.getTheme("daily"),
					n = this.getTheme("icon");
				this.getTheme("padding");
				return this.add(t.icon, n["icon" + e])
			}, t.prototype.render = function() {
				var e = (0, p.default)(),
					t = e.add(1, "days").format("ddd").toLowerCase(),
					n = e.add(1, "days").format("ddd").toLowerCase(),
					r = this.props,
					o = r.daily,
					i = r.language,
					a = this.getTheme("daily"),
					u = this.getTheme("padding"),
					s = this.getLocale("today"),
					l = this.getLocale(t),
					c = this.getLocale(n),
					f = o.map(function(e) {
				...
				return d.default.createElement("div", {
					...
					className: a.itemLeftSplitter
				}, d.default.createElement("div", {
					className: a.title
				}, s), d.default.createElement("div", {
					className: this.getWeatherIcon(o[0].code_day)
				}), d.default.createElement("div", {
					className: this.getSubtitleClassName(a, i)
				}, f[0]), d.default.createElement("div", {
					className: a.subtitle2
				}, h[0])), d.default.createElement("div", {
					className: a.item
				}, d.default.createElement("div", {
					className: a.title
				}, l), d.default.createElement("div", {
					className: this.getWeatherIcon(o[1].code_day)
				}), d.default.createElement("div", {
					className: this.getSubtitleClassName(a, i)
				}, f[1]), d.default.createElement("div", {
					className: a.subtitle2
				}, h[1])), d.default.createElement("div", {
					className: a.itemRightSplitter
				}, d.default.createElement("div", {
					className: a.title
				}, c), d.default.createElement("div", {
					className: this.getWeatherIcon(o[2].code_day)
				}), d.default.createElement("div", {
					className: this.getSubtitleClassName(a, i)
				}, f[2]), d.default.createElement("div", {
					className: a.subtitle2
				}, h[2])))
			}, t
		}((0, v.default)(h.ThemeableMixin));
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.handleClick = function(e) {
				...
				var e = this.props.type,
					t = this.getTheme("copyright"),
					n = this.getTheme("padding");
				return "slim" == e ? d.default.createElement("div", {
					className: this.add(t.container, n.copyright),
					onClick: this.handleClick.bind(this)
				}, "Powered by ", this.getLocale("thinkpage")) : d.default.createElement("div", {
					className: this.add(t.container, n.copyright)
				}, d.default.createElement("span", {
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getIconClassName = function() {
				var e = this.props.now,
					t = this.getTheme("icon");
				return t["iconHuge" + e.code]
			}, t.prototype.render = function() {
				var e = this.getTheme("icon"),
					t = this.getTheme("padding");
				return d.default.createElement("div", {
					className: this.add(e.iconHuge, this.getIconClassName(), t.iconHuge)
				})
			}, t
		}((0, h.default)(f.ThemeableMixin));
	t.default = m
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.render = function() {
				var e = this.props.now,
					...
					n = this.getTheme("padding"),
					r = void 0;
				return r = e.temperature <= -10 || e.temperature >= 100 ? t.temperature + " " + t.temperature_minus : "" + t.temperature, d.default.createElement("div", {
					className: this.add(t.title, n.now)
				}, d.default.createElement("span", {
					className: r
		...
		m = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.getClass = function() {
				...
				return d.default.createElement("div", {
					...
					className: e.blob + " " + e.blob0
				}), d.default.createElement("div", {
					className: e.blob + " " + e.blob1
				}), d.default.createElement("div", {
					className: e.blob + " " + e.blob2
				}), d.default.createElement("div", {
					className: e.blob + " " + e.blob3
				}), d.default.createElement("div", {
					className: e.blob + " " + e.blob4
				}), d.default.createElement("div", {
					className: e.blob + " " + e.blob5
				}))
			}, t
		}((0, h.default)(f.ThemeableMixin));
	t.default = m
		...
		E = (r(M), function(e) {
			...
			return(0, l.default)(t, e), t.prototype.componentDidMount = function() {
				...
				var e = this.props,
					t = e.actions,
					n = e.load;
				"dataConfig" == n && (this.preloadedPrepare(), t.setLoading({
					load: "loaded"
				}))
			}, t.prototype.preloadedPrepare = function() {
				var e = this.props,
	...
	var o = n(192),
		...
		v = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.componentDidMount = function() {
				...
				var t = this.getTheme("iconWhite"),
					n = this.getTheme("cover");
				...
				var e = this.props,
					t = e.weather,
					n = e.config,
					r = this.getTheme("container"),
					o = this.getTheme("cover"),
				...
				return i.type = n.alarmType, i.glance = n._glance, d.default.createElement("div", {
					...
					style: this.getColor()
				}, t.location.name), d.default.createElement("div", {
					className: this.add("tpwidget_icon_hook", this.getWeatherIcon(t.now.code))
				}), d.default.createElement("div", {
	...
	var o = n(192),
		...
		N = function(e) {
			...
			return(0, l.default)(t, e), t.prototype.componentDidMount = function() {
				var e = this.props.actions,
					t = this.getTheme("container"),
					n = document.getElementsByClassName(t.front)[0];
				e.setPage({
					width: window.innerWidth,
					height: window.innerHeight
				}), e.setOffset((0, m.getElementOffset)(n))
			}, t.prototype.componentDidUpdate = function() {
				var e = this.props.page;
				if(!e.mouseOver) {
					var t = {},
						n = e.offsetLeft - e.scrollLeft,
				...
				var e = this.props,
					...
					r = e.page,
					o = e.language,
					i = this.state.bubblePadding,
					a = this.getTheme("container"),
					u = this.getTheme("padding"),
					s = t.now,
					l = {};
	...
	function o(e) {
		var t = window.devToolsExtension ? window.devToolsExtension()(i.createStore) : i.createStore,
			n = (0, i.applyMiddleware)(u.default, l.default)(t),
			r = n(d.default, e);
		return r
	}
	t.__esModule = !0, t.default = o;
	...
	e.exports = !s || n(214)(function() {
		...
		for(var n = a(e), s = arguments.length, l = 1, c = o.f, d = i.f; s > l;)
			for(var f, p = u(arguments[l++]), h = c ? r(p).concat(c(p)) : r(p), m = h.length, v = 0; m > v;) d.call(p, f = h[v++]) && (n[f] = p[f]);
		return n
	} : s
}, function(e, t, n) {
	"use strict";
	...
	t.default = (0, a.handleActions)({
		SET_PAGE: function(e, t) {
			var n = t.payload.width,
				r = t.payload.height,
				o = (0, i.default)({}, e.page, {
					pageWidth: n,
					pageHeight: r
				});
			return(0, i.default)({}, e, {
		...
		SET_SCROLL: function(e, t) {
			var n = t.payload.scrollLeft,
				r = t.payload.scrollTop,
				o = (0, i.default)({}, e.page, {
					scrollLeft: n,
					scrollTop: r
				});
		...
		SET_OFFSET: function(e, t) {
			var n = t.payload.offsetLeft,
				r = t.payload.offsetTop,
				o = (0, i.default)({}, e.page, {
					offsetLeft: n,
					offsetTop: r
				});
		...
		SET_MOUSE_OVER: function(e, t) {
			var n = t.payload.mouseOver,
				r = (0, i.default)({}, e.page, {
					mouseOver: n
				});
			return(0, i.default)({}, e, {
				page: r

...
module.exports = {
  ...
  create: function (req, res, next) {
    pool.getConnection (function (err, connection) {
      ...
      // 建立连接，向表中插入值
      let paramNeedObj = {
        article_name: {require: true, name: '文章标题', code: 'code_4'},
        article_content: {require: true, name: '文章内容', code: 'code_5'},
      };
  ...
  query: function (req, res, next) {
    pool.getConnection (function (err, connection) {
      ...
      var data = checkAttr (param, paramNeedObj);
      if (data) {
        let sql =
  ...
  detail: function (req, res, next) {
    pool.getConnection (function (err, connection) {
      ...
      // 建立连接，向表中插入值
      let paramNeedObj = {
        article_id: {require: true, name: '文章ID', code: 'code_8'},
      };
